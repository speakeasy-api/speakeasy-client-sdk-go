...
// Generated from OpenAPI doc version 0.4.0 and generator version 2.884.4
...
func New(opts ...SDKOption) *Speakeasy {
	sdk := &Speakeasy{
		SDKVersion: "3.27.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 3.27.0 2.884.4 0.4.0 github.com/speakeasy-api/speakeasy-client-sdk-go/v3",
