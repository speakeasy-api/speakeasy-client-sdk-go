...
func (s *Workspaces) GetPublishingToken(ctx context.Context, opts ...operations.Option) (*operations.GetPublishingTokenResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Workspaces) SetFeatureFlags(ctx context.Context, request shared.WorkspaceFeatureFlagRequest, opts ...operations.Option) (*operations.SetWorkspaceFeatureFlagsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/workspace/feature_flags")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.SetWorkspaceFeatureFlagsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
