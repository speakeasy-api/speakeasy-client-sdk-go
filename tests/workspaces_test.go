...
func TestWorkspaces_GetPublishingToken(t *testing.T) {
	...
	assert.Equal(t, []shared.PublishingToken{
		shared.PublishingToken{
			...
			Token:          "<value>",
			TokenName:      "<value>",
			ValidUntil:     types.MustTimeFromString("2024-12-10T23:57:08.014Z"),
			WorkspaceID:    "<id>",
		},
		shared.PublishingToken{
			...
			Token:          "<value>",
			TokenName:      "<value>",
			ValidUntil:     types.MustTimeFromString("2024-02-04T17:07:30.748Z"),
			WorkspaceID:    "<id>",
		},
		shared.PublishingToken{
			...
			Token:          "<value>",
			TokenName:      "<value>",
			ValidUntil:     types.MustTimeFromString("2025-02-17T17:19:25.961Z"),
			WorkspaceID:    "<id>",
		},
	}, res.Classes)
