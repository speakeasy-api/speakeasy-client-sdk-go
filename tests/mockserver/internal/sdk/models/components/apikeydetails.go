...
type APIKeyDetails struct {
	...
	//
	LicenseJwt optionalnullable.OptionalNullable[string] `json:"license_jwt,omitempty"`
}
...
func (a *APIKeyDetails) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, []string{"workspace_id", "workspace_slug", "org_slug", "account_type_v2", "enabled_features", "billing_add_ons", "telemetry_disabled", "workspace_created_at"}); err != nil {
		return err
	}
	return nil
}
...
func (o *APIKeyDetails) GetLicenseJwt() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.LicenseJwt
