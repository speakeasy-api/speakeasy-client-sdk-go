...
func (t *TargetSDK) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &t, "", false, []string{"id", "last_event_id", "last_event_created_at", "last_event_interaction_type", "generate_target", "generate_gen_lock_id"}); err != nil {
		return err
	}
	return nil
}
