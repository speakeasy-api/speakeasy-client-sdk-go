...
func (r *RevisionContentsMetadata) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &r, "", false, []string{"type", "workspace_id", "namespace", "revision_digest", "title", "description", "version", "hash", "tags", "operation_ids", "num_overlay_actions", "contains_code_samples", "created_at", "server_urls"}); err != nil {
		return err
	}
	return nil
}
...
func (o *RevisionContentsMetadata) GetRelativeDiff() *RelativeDiff {
	if o == nil {
		return nil
	}
	return o.RelativeDiff
}
...
func (o *RevisionContentsMetadata) GetServerUrls() []Server {
	if o == nil {
		return []Server{}
	}
	return o.ServerUrls
