...
func pathPostV1ArtifactsNamespacesNamespaceNameVisibility(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
...
func testSetVisibilitySetVisibility0(w http.ResponseWriter, req *http.Request) {
