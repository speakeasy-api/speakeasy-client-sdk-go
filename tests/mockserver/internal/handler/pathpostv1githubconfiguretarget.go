...
func pathPostV1GithubConfigureTarget(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
...
func testGithubConfigureTargetGithubConfigureTarget0(w http.ResponseWriter, req *http.Request) {
