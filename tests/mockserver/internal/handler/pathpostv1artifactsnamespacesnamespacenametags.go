...
func pathPostV1ArtifactsNamespacesNamespaceNameTags(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
...
func testPostTagsPostTags0(w http.ResponseWriter, req *http.Request) {
