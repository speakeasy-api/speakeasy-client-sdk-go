...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodDelete, "/v1/publishing-tokens/{tokenID}", pathDeleteV1PublishingTokensTokenID(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/publishing-tokens", pathPostV1PublishingTokens(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPut, "/v1/publishing-tokens/{tokenID}", pathPutV1PublishingTokensTokenID(dir, rt)),
