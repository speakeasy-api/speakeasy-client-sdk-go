...
func pathPostV1ArtifactsNamespacesNamespaceNameArchive(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
...
func testArchiveNamespaceArchiveNamespace0(w http.ResponseWriter, req *http.Request) {
