...
func pathPostV1GithubConfigureMintlifyRepo(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
...
func testGithubConfigureMintlifyRepoGithubConfigureMintlifyRepo0(w http.ResponseWriter, req *http.Request) {
