...
func TestSpeakeasy_CreatePublishingToken(t *testing.T) {
	...
	res, err := s.PublishingTokens.Create(ctx, &operations.CreatePublishingTokenRequestBody{
		...
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2025-04-24T14:17:38.418Z"),
	})
	require.NoError(t, err)
	assert.Equal(t, 200, res.StatusCode)
	...
	assert.Equal(t, &shared.PublishingToken{
		...
		Token:          "<value>",
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2026-09-04T09:11:49.246Z"),
		WorkspaceID:    "<id>",
	}, res.PublishingToken)
...
func TestSpeakeasy_GetPublishingTokenByID(t *testing.T) {
	...
	assert.Equal(t, &shared.PublishingToken{
		...
		Token:          "<value>",
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2026-11-22T04:11:06.908Z"),
		WorkspaceID:    "<id>",
	}, res.PublishingToken)
