...
func TestSpeakeasy_CreatePublishingToken(t *testing.T) {
	...
	res, err := s.PublishingTokens.Create(ctx, &operations.CreatePublishingTokenRequestBody{
		...
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2026-09-05T16:01:57.837Z"),
	})
	require.NoError(t, err)
	assert.Equal(t, 200, res.StatusCode)
	...
	assert.Equal(t, &shared.PublishingToken{
		...
		Token:          "<value>",
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2024-01-16T13:31:14.058Z"),
		WorkspaceID:    "<id>",
	}, res.PublishingToken)
...
func TestSpeakeasy_GetPublishingTokenByID(t *testing.T) {
	...
	assert.Equal(t, &shared.PublishingToken{
		...
		Token:          "<value>",
		TokenName:      "<value>",
		ValidUntil:     types.MustTimeFromString("2024-02-22T19:48:36.338Z"),
		WorkspaceID:    "<id>",
	}, res.PublishingToken)
