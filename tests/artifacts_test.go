...
func TestArtifacts_GetManifest(t *testing.T) {
	...
	assert.Equal(t, &shared.Manifest{
		Layers: []shared.V2Descriptor{
			shared.V2Descriptor{
				Digest:    speakeasyclientsdkgo.Pointer("sha256:5d20c808ce198565ff70b3ed23a991dd49afac45dece63474b27ce6ed036adc6"),
				MediaType: speakeasyclientsdkgo.Pointer("application/vnd.docker.image.rootfs.diff.tar.gzip"),
				Size:      speakeasyclientsdkgo.Pointer[int64](2107098),
			},
		},
		MediaType:     speakeasyclientsdkgo.Pointer("application/vnd.docker.distribution.manifest.v2+json"),
		SchemaVersion: speakeasyclientsdkgo.Pointer[int64](2),
	}, res.Manifest)
