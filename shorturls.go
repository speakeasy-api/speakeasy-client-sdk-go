...
func newShortURLs(rootSDK *Speakeasy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ShortURLs {
	return &ShortURLs{
		rootSDK:          rootSDK,
...
func (s *ShortURLs) Create(ctx context.Context, request operations.CreateRequestBody, opts ...operations.Option) (*operations.CreateResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/short_urls")
	if err != nil {
